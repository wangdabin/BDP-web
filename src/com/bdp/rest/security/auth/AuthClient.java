package com.bdp.rest.security.auth;
...
public     AuthClient () throws java.io.IOException{
super(ClientConfigUtils.create());
}
//POST
public   com.joe.user.vo.AuthResult  auth (com.joe.user.vo.AuthUser param0) {
String resource = getConf().getString("server.security.resource.auth");
MultivaluedMap<String, String> queryParams = new MultivaluedMapImpl();
Map<String, String> headerParams = new HashMap<String, String>();
List<Cookie> cookies = new ArrayList<Cookie>();
return this.doPost(com.joe.user.vo.AuthResult.class,resource, queryParams, headerParams, cookies,param0);
}
