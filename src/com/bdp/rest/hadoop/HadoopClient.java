...
public     HadoopClient () throws java.io.IOException{
super(ClientConfigUtils.create());
}
//POST
public   com.joe.core.vo.ReCode  deployHadoop (com.joe.service.vo.ServiceVo param0) {
String resource = getConf().getString("server.ws.resource.hadoop.deploy");
